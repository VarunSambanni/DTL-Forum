                ...
                <Grid item md={showDrawer ? 9.8 : 12} sm={12}>
                    <div className='forumWrapper'>
                        ...
                        <div className='postsWrapper'>
                            <div className='note'>
                                <b>Note :</b> The score of a user shows how interactive and involved a user is in this community. It is calculated with the help of the user's replies, upvotes and posts.
                            </div>
